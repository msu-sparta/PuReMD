...
void Compute_Potential_Energy(simulation_data* data)
{
...
void Compute_Restraint_Energy(simulation_data *data)
{
    data->E_Total_Rest = data->E_Bond_Rest + data->E_Ang_Rest + data->E_Tors_Rest;
}
