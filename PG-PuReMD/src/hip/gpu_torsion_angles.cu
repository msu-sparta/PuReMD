        ...
        output_controls const * const out_control )
{
    ...
    hipEventRecord( control->gpu_time_events[TE_TORSION_START], control->gpu_streams[3] );
#endif
...
#if defined(LOG_PERFORMANCE)
    hipEventRecord( control->gpu_time_events[TE_TORSION_STOP], control->gpu_streams[3] );
#endif
}
