 ...
 */
void GPU_Reduction_Sum( int *d_array, int *d_dest, size_t n, int s_index, hipStream_t s )
{
 ...
 * s: stream to perform the reduction in
 */
void GPU_Reduction_Sum( real *d_array, real *d_dest, size_t n, int s_index, hipStream_t s )
{
    static void *d_temp_storage[MAX_GPU_STREAMS] = { NULL };
    static size_t temp_storage_bytes[MAX_GPU_STREAMS] = { 0 };
    void *temp = NULL;
...
void GPU_Scan_Excl_Sum( int *d_src, int *d_dest, size_t n, int s_index, hipStream_t s )
{
    static void *d_temp_storage[MAX_GPU_STREAMS] = { NULL };
    static size_t temp_storage_bytes[MAX_GPU_STREAMS] = { 0 };
    void *temp = NULL;
