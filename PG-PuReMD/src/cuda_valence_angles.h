...
CUDA_DEVICE static inline void Calculate_Theta( rvec dvec_ji, real d_ji, rvec dvec_jk, real d_jk,
...
CUDA_DEVICE static inline void Calculate_dCos_Theta( rvec dvec_ji, real d_ji, rvec dvec_jk, real d_jk,
        rvec* dcos_theta_di,
        rvec* dcos_theta_dj,
        rvec* dcos_theta_dk )
{
