...
void GPU_Compute_Bond_Orders( reax_system const * const, control_params const * const, 
        simulation_data * const, storage * const, reax_list ** const,
        output_controls const * const );

void GPU_Total_Forces_Part1( reax_system const * const, control_params const * const,
        simulation_data * const, storage *, reax_list ** const );

void GPU_Total_Forces_Part2( reax_system * const, control_params const * const,
        storage * const );
...
GPU_DEVICE static inline void GPU_Compute_BOp( reax_list bond_list, real bo_cut,
