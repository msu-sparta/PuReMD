...
static inline GPU_HOST_DEVICE int index_grid_3d( int i, int j, int k,
        grid const * const g )
{
...
static inline GPU_HOST_DEVICE int index_grid_3d_v( ivec x,
        grid const * const g )
{
...
static inline GPU_HOST_DEVICE int index_grid_nbrs( int i, int j, int k, int l,
        grid const * const g )
{
...
static inline GPU_HOST_DEVICE int index_tbp( int i, int j, int num_atom_types )
{
    return (i * num_atom_types) + j;
}

/* Indexing routine for three body parameters */
static inline GPU_HOST_DEVICE int index_thbp( int i, int j, int k, int num_atom_types )
{
    return (i * num_atom_types * num_atom_types) + (j * num_atom_types) + k;
}

/* Indexing routine for hydrogen bonding parameters */
static inline GPU_HOST_DEVICE int index_hbp( int i, int j, int k, int num_atom_types )
{
    return (i * num_atom_types * num_atom_types) + (j * num_atom_types) + k;
}

/* Indexing routine for four body parameters */
static inline GPU_HOST_DEVICE int index_fbp( int i, int j, int k, int l, int num_atom_types )
{
...
static inline GPU_HOST_DEVICE int index_lr( int i, int j, int num_atom_types )
{
    return (i * num_atom_types) + j;
}
